...
# Directional patterns: buy the option in the expected direction
BUY_PATTERNS  = {"gap_fill", "oi_buildup", "vwap_oi", "pcr_divergence", "mean_reversion", "max_pain"}
# Premium selling patterns: direction-neutral, just sell elevated vol
