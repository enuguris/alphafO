...
const DETAILS: Record<NodeId, Detail> = {
  ...
  patterns: {
    ...
    bullets:[
      ...
      'expiry_week classified as SELL_PATTERNS — sells OTM strangle (not a directional BUY)',
      'BUY_PATTERNS: gap_fill, oi_buildup, vwap_oi, pcr_divergence (directional long bias)',
      'SELL_PATTERNS: iv_crush, mean_reversion, max_pain, expiry_week (premium selling)',
    ],
  ...
  options: {
    ...
    bullets:[
      ...
      'Regime — uses date-seeded OHLCV + real India VIX (not fixed-seed random) for volatility class',
    ],
